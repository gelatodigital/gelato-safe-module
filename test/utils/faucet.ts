...
export const getTokenFromFaucet = async (tokenAddress: string, recepient: string, amount: BigNumber) => {
  // Fetch actual Faucet
  ...
  if (faucet !== getFaucetByToken("0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee") && faucetEthBalance.lt(oneEth)) {
