...
export interface IOpsInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: "createTask", values: [string, BytesLike, ModuleDataStruct, string]): string;
...
export interface IOps extends BaseContract {
  ...
  estimateGas: {
    cancelTask(taskId: BytesLike, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>;
