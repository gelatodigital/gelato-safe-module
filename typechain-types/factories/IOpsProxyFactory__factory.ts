...
import type { IOpsProxyFactory, IOpsProxyFactoryInterface } from "../IOpsProxyFactory";
...
export class IOpsProxyFactory__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): IOpsProxyFactory {
